...
const World = dynamic(() => import("./GlobeOut").then((m) => m.World), {
  ssr: false,
});
...
export function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-gl md:h-auto bg-black  relative w-full">
